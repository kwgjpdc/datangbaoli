			...
			<el-collapse-item title="基本信息" name="1">
				<el-row :gutter="15" style="margin-right: 30px">
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item
							:label="'工商注册号/\n统一社会信用代码'"
							prop="companyInfo.creditCode"
						>
							<row>
								<el-input
									class="fixed-width-input"
									v-model="formData.companyInfo.creditCode"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="公司成立日" prop="companyInfo.foundDate">
							<el-date-picker
								clearable
								v-model="formData.companyInfo.foundDate"
								type="date"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="上级公司" prop="companyInfo.parentCustomerId">
							<CustomerSelect
								:option="parentCustomer.option"
								:showValue="parentCustomer.showValue"
								:queryPropList="parentCustomer.queryPropList"
								:tablePropList="parentCustomer.tablePropList"
								@selectRow="parentCustomerSelect"
							></CustomerSelect>
						</el-form-item>
					</el-col>
					<el-col :xl="12" :lg="16" :sm="24">
						<div class="form-address-all">
							...
							<el-form-item
								prop="companyInfo.registerAddr"
								class="address-detail"
							>
								<el-input
									v-model="formData.companyInfo.registerAddr"
									placeholder="请输入详细地址"
									clearable
									maxlength="64"
								></el-input>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="集团内客户" prop="companyInfo.blocCustomer">
							<el-select
								v-model="formData.companyInfo.blocCustomer"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in sys_true_or_false"
									:key="item.value"
									:label="item.label"
									:value="item.value"
								>
					...
					<el-col :xl="12" :lg="16" :sm="24">
						<el-form-item label="办公地址" prop="companyInfo.operateAddr">
							<el-input
								class="fixed-width-input"
								v-model="formData.companyInfo.operateAddr"
								placeholder="请输入办公地址"
								clearable
								maxlength="64"
							></el-input> </el-form-item
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="公司传真" prop="companyInfo.companyFax">
							<el-input
								class="fixed-width-input"
								v-model="formData.companyInfo.companyFax"
								oninput="value=value.replace(/[^0-9-+]/,'')"
								placeholder="请输入公司传真"
								clearable
								maxlength="255"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item
							label="上市公司标记"
							prop="companyInfo.listedCompanyMark"
						>
							<el-select
								v-model="formData.companyInfo.listedCompanyMark"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in cust_listed_mark"
									:key="item.value"
									:label="item.label"
									:value="item.value"
								>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="客户邮箱" prop="companyInfo.companyMail">
							<el-input
								class="fixed-width-input"
								v-model="formData.companyInfo.companyMail"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="注册资本" prop="registerCapital">
							<ElPriceInput
								v-model:form="formData.companyInfo"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="管理特征" prop="companyInfo.manageFeature">
							<el-select
								v-model="formData.companyInfo.manageFeature"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in cust_manage_features"
									:key="item.value"
									:label="item.label"
									:value="item.label"
								>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item
							label="中登网行业分类"
							prop="companyInfo.industryClassify"
						>
							<el-input
								class="fixed-width-input"
								v-model="formData.companyInfo.industryClassify"
								placeholder="请输入中登网行业分类"
								clearable
								maxlength="255"
							></el-input> </el-form-item
					></el-col>
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="经营状况" prop="companyInfo.businessState">
							<el-select
								v-model="formData.companyInfo.businessState"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in cust_business_status"
									:key="item.value"
									:label="item.label"
									:value="item.label"
								>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item
							label="注册核准日期"
							prop="companyInfo.registerApprovalDate"
						>
							<el-date-picker
								clearable
								v-model="formData.companyInfo.registerApprovalDate"
								type="date"
								value-format="YYYY-MM-DD"
								placeholder="请选择"
							>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="员工人数" prop="companyInfo.employeeNumber">
							<el-input
								class="fixed-width-input"
								v-model="formData.companyInfo.employeeNumber"
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="经营规模" prop="companyInfo.businessScale">
							<el-select
								v-model="formData.companyInfo.businessScale"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in cust_enterprise_size"
									:key="item.value"
									:label="item.label"
									:value="item.label"
								>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item label="经济类型" prop="companyInfo.economicType">
							<el-select
								v-model="formData.companyInfo.economicType"
								filterable
								placeholder="请选择"
							>
								<el-option
									v-for="item in cust_economy_type"
									:key="item.value"
									:label="item.label"
									:value="item.label"
								>
					...
					<el-col :xl="6" :lg="8" :sm="12" :xs="24">
						<el-form-item
							label="国标行业分类"
							prop="companyInfo.nationalIndustryClassify"
						>
							<el-select
								filterable
								placeholder="请选择"
								v-model="formData.companyInfo.nationalIndustryClassify"
							>
								<el-option
									v-for="item in cust_industry_type"
									:key="item.value"
									:label="item.label"
									:value="item.label"
								>
...
import { tycInfo } from "@/api/outside/tyc";
...
// 天眼查 查询
function getTynInfo() {
	if (!formData.value.companyInfo.creditCode) {
		return proxy.$message.warning("请先输入正确的工商注册号！");
	}

	fullscreenLoading.value = true;
	const keyWord = formData.value.companyInfo.creditCode;
	tycInfo({ keyWord })
		.then(res => {
			formData.value.companyInfo = res.data;

			// formData.value.companyInfo.businessScope = res.businessScope;
			// formData.value.companyInfo.businessState = res.businessState; // 字典
			// formData.value.companyInfo.businessTermEndDate = res.businessTermEndDate; // 时间戳
			// formData.value.companyInfo.businessTermStartDate =
			// 	res.businessTermStartDate;

			// businessScope: "开发建设运营风电场；风力发电技术咨询、培训、服务和研究开发；风电设备检修与调试；风电项目策划、咨询、管理；电力物资产品销售。";
			// businessState: "存续";
			// businessTermEndDate: null;
			// businessTermStartDate: "1508083200000";
			// corporationName: "付晖";
			// creditCode: "91410526MA44G9JM01";
			// economicType: "有限责任公司（非自然人投资或控股的法人独资）";
			// employeeNumber: "50-99人";
			// foundDate: "1508083200000";
			// nationalIndustryClassify: '{"category": "电力、热力、燃气及水生产和供应业", "categoryBig": "电力、热力生产和供应业", "categorySmall": "核力发电", "categoryMiddle": "电力生产"}';
			// realIncomeCapital: "44579.00";
			// registerAddr: "滑县高平镇政府院内";
			// registerApprovalDate: "1716998400000";
			// registerCapital: "44579.00";
			// taxpayerIdNo: "91410526MA44G9JM01";
		})
		.finally(() => {
