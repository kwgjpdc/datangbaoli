<template>
  <div class="info-form">
      ...
      <el-collapse v-model="activeNames" style="border-top: 0;">
        <el-collapse-item title="客户账号管理" name="8">
          ...
          <el-card class="box-card">
            ...
            <el-table :data="formData.bankInfoList" @selection-change="handleSelectionChange">
              <el-table-column type="selection" width="55" align="center" :disabled="props.routerQueryObj.viewFlag" />
              <el-table-column label="账号种类" align="center" prop="accountType">
                <template #default="scope">
                  <dict-tag :options="cust_account_type" :value="scope.row.accountType" />
                  <!-- <el-select v-model="scope.row.accountType" filterable placeholder="请选择"
                        :style="{ width: '240px' }">
              ...
              <el-table-column label="币种" align="center" prop="currencyType">
                ...
                <template #default="scope">
                  ...
                  <!-- <el-select v-model="scope.row.currencyType" filterable placeholder="请选择"
                        :style="{ width: '240px' }">
                        <el-option v-for="item in cust_company_type" :key="item.value" :label="item.label"
                          :value="item.value">
                        </el-option>
                      </el-select> -->
                </template>
              ...
              <el-table-column label="开户行" align="center" prop="bankBranch">
                ...
                <!-- <template #default="scope">
                      <el-input v-model="scope.row.bankBranch" placeholder="请输入" :style="{ width: '240px' }" />
                    </template> -->
              </el-table-column>
              <el-table-column label="账号" align="center" prop="bankAccount">

                <!-- <template #default="scope">
                      <el-input v-model="scope.row.bankAccount" placeholder="请输入" :style="{ width: '240px' }" />
                    </template> -->
              </el-table-column>
              <el-table-column label="大额行号" align="center" prop="bankCode">

                <!-- <template #default="scope">
                      <el-input v-model="scope.row.bankCode" placeholder="请输入" :style="{ width: '240px' }" />
                    </template> -->
              </el-table-column>
              <el-table-column label="户名" align="center" prop="accountName">

                <!-- <template #default="scope">
                      <el-input v-model="scope.row.customerId" placeholder="请输入" :style="{ width: '240px' }" />
                    </template> -->
              </el-table-column>
    ...
    <!-- 添加或修改用户配置对话框 -->
    <el-dialog title="客户账户" :model-value="openAccountAdd" width="800px" @closed="closeAccountAdd(false)">
      <el-form ref="formInput" label-width="110px" :model="accountFormInput" :rules="accountAddrules">
        <el-row>
          <el-col :span="12">
            <el-form-item label="账号种类" prop="accountType">

              <el-select v-model="accountFormInput.accountType" filterable placeholder="请选择"
                :style="{ width: '240px' }">
                <el-option v-for="item in cust_account_type" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="币种 " prop="currencyType">
              <el-select v-model="accountFormInput.currencyType" filterable placeholder="请选择"
                :style="{ width: '240px' }">
          ...
          <el-col :span="12">
            <el-form-item label="开户行" prop="bankBranch">
              <el-input placeholder="请输入开户行" maxlength="64" v-model="accountFormInput.bankBranch"
                :style="{ width: '240px' }"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="账号" prop="bankAccount">
              <el-input placeholder="请输入账号" maxlength="64" v-model="accountFormInput.bankAccount"
                :style="{ width: '240px' }"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="大额行号" prop="bankCode">
              <el-input placeholder="请输入大额行号" maxlength="64" v-model="accountFormInput.bankCode"
                :style="{ width: '240px' }"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="户名" prop="accountName">
              <el-input placeholder="请输入户名" maxlength="64" v-model="accountFormInput.accountName"
                :style="{ width: '240px' }"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item>
              ...
              <el-button type="primary" @click="closeAccountAdd(false)">取消</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
let accountFormInput = ref({
  "customerId": props.customerId && props.customerId !== '' ? props.customerId : "",
  "remark": null,
  "accountType": "",
  "currencyType": "",
  "bankBranch": "",
...
const { sys_currency_type, cust_account_type } = proxy.useDict("sys_currency_type", "cust_account_type");//下拉框字典
...
function handleDelete(rows) {
  ...
  proxy.$modal.confirm('是否确认删除户名为"' + accountNames + '"的数据项？').then(function () {
    accountNames.forEach((names) => {
      console.log(names)
      formData.value.bankInfoList = formData.value.bankInfoList.filter((item) => {
