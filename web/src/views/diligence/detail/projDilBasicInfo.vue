            ...
            <el-collapse-item title="基本信息" name="0">
              ...
              <el-form-item label="审议日期" prop="reviewDate">
                <el-date-picker clearable v-model="formData.reviewDate" type="date"
                                value-format="YYYY-MM-DD" placeholder="系统自动生成" :style="{ width: '240px' }"
                                disabled>
                </el-date-picker>
              </el-form-item>
              ...
              <el-form-item label="保理融资额度到期日" prop="financeLimitExpireDate">
                <el-date-picker clearable v-model="formData.financeLimitExpireDate" type="date"
                                value-format="YYYY-MM-DD" placeholder="授信生效日期向后顺延365天"
                                :style="{ width: '240px' }">
                </el-date-picker>
...
" style="color: var(--el-input-icon-color,var(--el-text-color-placeholder));"></span>
                ...
                <el-form-item label="保理融资额度期限" prop="financeLimitPeriod">
                  <el-input v-model="formData.financeLimitPeriod" placeholder="请输入保理融资额度期限" clearable
                            maxlength="9"
                ...
                <el-form-item label="保理期" prop="factoringPeriod">
                  <el-input v-model="formData.factoringPeriod" placeholder="请输入保理期" clearable
                ...
                <el-form-item label="宽限期利率" prop="gracePeriodInterestRate">
                  <el-input v-model="formData.gracePeriodInterestRate" placeholder="请输入宽限期利率" clearable
                            oninput="value=value.replace(/[^0-9]/g,'')" maxlength="9"
                            :style="{ width: '240px' }">
                    <template #suffix>
                      <span> %/年 </span>
                ...
                <el-form-item label="宽限期" prop="gracePeriod">
                  <el-input v-model="formData.gracePeriod" placeholder="请输入宽限期" clearable
                            oninput="value=value.replace(/[^0-9]/g,'')" maxlength="9"
                            :style="{ width: '240px' }">
                    <template #suffix>
                      <span> 日 </span>
                ...
                <el-form-item label="保理标的" prop="factoringTarget">
                  <el-select v-model="formData.factoringTarget" filterable placeholder="请选择保理标的"
                             :style="{ width: '240px' }">
		...
		<el-form-item label="标的" prop="baseItem">
                ...
                <el-form-item label="利息支付宽限期" prop="interestPaymentGracePeriod">
                  <el-input v-model="formData.interestPaymentGracePeriod" placeholder="请输入利息支付宽限期" clearable
                            oninput="value=value.replace(/[^0-9]/g,'')" maxlength="9"
                            :style="{ width: '240px' }">
                    <template #suffix>
                      <span>天</span>
                ...
                <el-form-item label="保理融资利率(%)" prop="factoringFinanceRate">
                  <el-input v-model="formData.factoringFinanceRate" placeholder="请输入保理融资利率" clearable
                            maxlength="9"
                            oninput="value=value.replace(/[^0-9]/g,'')" :style="{ width: '240px' }"
                            @input="handleInput($event,'factoringFinanceRate')">
                    <template #suffix>
                      <span> %/年 </span>
                    </template>
                  </el-input>
                </el-form-item>
                <PriceInput v-model:form="formData" :width="240" label="保理融资额度金额" prop="penaltyFee"
                            :rules="rules">
                  <template #prefix>
                  <span
                      class="iconfont icon-tubiaozhizuomoban"
                      style="color: var(--el-input-icon-color,var(--el-text-color-placeholder));"
                  ></span>
                  </template>
                  <template #suffix>
                    <span> 万元 </span>
                ...
                <el-table v-loading="loading" :data="formData.loanList"
                  ...
                  <el-table-column label="放款比例" align="center" prop="loanRatio" width="300">
                    <template #default="scope">
                      <el-input v-model="scope.row.loanRatio" placeholder="请输入" clearable
                                oninput="value=value.replace(/[^0-9]/g,'')" maxlength="32"
                                :style="{ width: '240px' }"/>
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template #default="scope">
                      <el-button link type="primary" icon="Delete"
                                 @click="handleDeleteLoanList(scope.row)">删除
                      </el-button>
                    </template>
                  </el-table-column>
                </el-table>
  ...
  rules:
      {
        ...
        factoringTarget: [
          {required: true, message: "保理标的不能为空", trigger: "blur"}
        ],
        interestPaymentGracePeriod: [
          {required: true, message: "利息支付宽限期不能为空", trigger: "blur"}
        ],
        factoringFinanceRate: [
          {required: true, message: "保理融资利率(%)不能为空", trigger: "blur"}
        ],
        penaltyFee: [
          {required: true, message: "保理融资额度金额不能为空", trigger: "blur"}
        ],
