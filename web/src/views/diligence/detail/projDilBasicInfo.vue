					...
					<el-collapse v-model="activeNames" @change="handleChange">
						<el-collapse-item title="基本信息" name="0">
							...
							<el-form-item label="提交部门" prop="submitDepartment">
								<el-select
									v-model="formData.submitDepartment"
									filterable
									placeholder="请选择"
									:style="{ width: '240px' }"
								>
							...
							>
								<el-date-picker
									clearable
									v-model="formData.financeLimitExpireDate"
									type="date"
									value-format="YYYY-MM-DD"
									placeholder="授信生效日期向后顺延365天"
									:style="{ width: '240px' }"
								>
								</el-date-picker>
							</el-form-item>
							...
							<attach-info
								id="attachInfo"
								ref="attachInfoRef"
								:commonFileList="formData.commonFileList"
								:routerQueryObj="routerQueryObj"
								:dilligenceId="dilligenceId"
							></attach-info>
						</el-collapse-item>
							...
							<el-card class="box-card">
								<el-form-item label="核心企业" prop="coreEnterpriseName">
									...
									<div @click="openDiagMulti('coreEnterpriseName')">
										<el-input
											v-model="formData.coreEnterpriseName"
											placeholder="请选择核心企业"
											clearable
											readonly
											suffix-icon="el-icon-search"
								...
								<el-form-item label="保理申请人" prop="factoringApplicantNo">
									<div @click="openDiagMulti('factoringApplicantName')">
										<el-input
											v-model="formData.factoringApplicantName"
											placeholder="请选择保理申请人"
											clearable
											readonly
											suffix-icon="el-icon-search"
											:style="{ width: '240px' }"
								...
								<el-form-item label="业务产品" prop="businessType">
									...
									<el-input
										...
										:disabled="formData.businessType != 6"
										maxlength="32"
									/>
								</el-form-item>
								<el-form-item
								...
								>
									<el-input
										v-model="formData.financeLimitPeriod"
										placeholder="请输入保理融资额度期限"
										clearable
										maxlength="9"
								...
								<el-form-item label="合同类型" prop="contractType">
									...
									>
										<el-option
											v-for="item in proj_dd_contract_type"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.contractTypeOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.contractType != 4"
										maxlength="32"
									/>
								</el-form-item>
								<el-form-item label="保理融资额度类型" prop="financeLimitType">
									...
									<el-radio-group
										v-model="formData.financeLimitType"
										:style="{ width: '240px' }"
									>
										<el-radio
											v-for="item in proj_dd_quota_type"
											:key="item.value"
											:label="item.value"
										>
											{{ item.label }}</el-radio
								...
								<el-form-item label="增信措施" prop="creditEnhancementMethod">
									...
									<el-select
										v-model="formData.creditEnhancementMethod"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_credit_enhancement"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.creditEnhancementMethodOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.creditEnhancementMethod != 6"
										maxlength="32"
									/>
								</el-form-item>
								...
								<el-form-item label="正常期利率" prop="normalTermInterestRate">
									<el-input
										v-model="formData.normalTermInterestRate"
										placeholder="请输入正常期利率"
										clearable
										oninput="value=value.replace(/[^0-9]/g,'')"
										:style="{ width: '240px' }"
										maxlength="9"
								...
								<el-form-item label="保理期" prop="factoringPeriod">
									<el-input
										v-model="formData.factoringPeriod"
										placeholder="请输入保理期"
										clearable
										oninput="value=value.replace(/[^0-9]/g,'')"
										maxlength="9"
								...
								<el-form-item label="宽限期利率" prop="gracePeriodInterestRate">
									<el-input
										v-model="formData.gracePeriodInterestRate"
								...
								<el-form-item label="违约利率" prop="defaultInterestRate">
									<el-input
										...
										oninput="value=value.replace(/[^0-9]/g,'')"
										:style="{ width: '240px' }"
										@input="handleInput($event, 'defaultInterestRate')"
									>
										<template #suffix>
											<span> %/日 </span>
										</template></el-input
								...
								>
									...
									<el-select
										v-model="formData.principalRepaymentMethod"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_capital_repay"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.principalRepaymentMethodOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.principalRepaymentMethod != 2"
										maxlength="32"
									/>
								</el-form-item>
								<el-form-item label="付息方式" prop="interestPaymentMethod">
									...
									<el-select
										v-model="formData.interestPaymentMethod"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_interest_payment"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.interestPaymentMethodOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.interestPaymentMethod != 5"
										maxlength="32"
									/>
								</el-form-item>
								<el-form-item label="付息方" prop="interestPayer">
									<el-select
										v-model="formData.interestPayer"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_interest_payer"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.interestPayerOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.interestPayer != 4"
										maxlength="32"
									/>
								</el-form-item>
								...
								>
									<el-select
										v-model="formData.managementPaymentMethod"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_management_fee"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.managementPaymentMethodOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.managementPaymentMethod != 5"
										maxlength="32"
									/>
								</el-form-item>
								...
								<el-form-item label="付费方" prop="payingParty">
									...
									<el-select
										v-model="formData.payingParty"
										filterable
										placeholder="请选择"
										:style="{ width: '115px' }"
									>
										<el-option
											v-for="item in proj_dd_management_fee_payer"
											:key="item.value"
											:label="item.label"
											:value="item.value"
										>
									...
									<el-input
										v-model="formData.payingPartyOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.payingParty != 4"
										maxlength="32"
									/>
								</el-form-item>

								<el-form-item label="标的" prop="baseItem">
									<el-select
									...
									<el-input
										v-model="formData.baseItemOther"
										placeholder="请输入"
										clearable
										:style="{ width: '115px', marginLeft: '10px' }"
										:disabled="formData.baseItem != 8"
										maxlength="100"
									/>
								</el-form-item>

								<el-form-item label="综合收益率" prop="comprehensiveIncome">
									<el-input
										v-model="formData.comprehensiveIncome"
										placeholder="请输入"
										clearable
										oninput="value=value.replace(/[^0-9]/g,'')"
										:style="{ width: '240px' }"
								...
								>
									...
									>
										<template #default="scope">
											<el-select
												v-model="scope.row.loanNodeBasis"
												filterable
												placeholder="请选择"
												:style="{ width: '315px' }"
												@visible-change="loanNodeBasisVisibleChange()"
											>
												<el-option
													v-for="item in proj_dd_loan_basis"
													:key="item.value"
													:label="item.label"
													:value="item.value"
											...
											<el-input
												v-model="scope.row.loanNodeBasisOther"
												placeholder="请输入"
												clearable
												maxlength="32"
												:style="{ width: '115px', marginLeft: '10px' }"
									...
									>
										<template #default="scope">
											<el-select
												v-model="scope.row.confirmationSeal"
												filterable
												placeholder="请选择"
												:style="{ width: '315px' }"
											>
												<el-option
													v-for="item in proj_dd_confirmation_seal"
													:key="item.value"
													:label="item.label"
													:value="item.value"
												>
											...
											<el-input
												v-model="scope.row.confirmationSealOther"
												placeholder="请输入"
												clearable
												:style="{ width: '115px', marginLeft: '10px' }"
												maxlength="32"
									...
									>
										<template #default="scope">
											<el-button
												...
												type="primary"
												icon="Delete"
												@click="handleDeleteLoanList(scope.row)"
												>删除</el-button
											>
										</template>
									</el-table-column>
								...
								<el-form-item label="确权方式" prop="confirmationMethod">
									...
									<el-radio-group
										v-model="formData.confirmationMethod"
										:style="{ width: '480px' }"
									>
										<el-radio
											v-for="item in proj_dd_confirmation"
											:key="item.value"
											:label="item.value"
										>
											{{ item.label }}</el-radio
								...
								<el-form-item label="结算账户" prop="settlementAccount">
									...
									>
										<el-radio
											v-for="item in proj_dd_settlement_account"
											:key="item.value"
											:label="item.value"
										>
											{{ item.label }}</el-radio
								...
								>
									<el-input
										v-model="formData.supplementaryInformation"
										type="textarea"
										placeholder="请输入内容"
										:style="{ width: '240px' }"
										maxlength="255"
...
const {
	...
	proj_dd_contract_type,
	proj_dd_credit_enhancement,
	proj_dd_capital_repay,
	proj_dd_interest_payment,
	proj_dd_interest_payer,
	proj_dd_management_fee,
	proj_dd_management_fee_payer,
	proj_dd_confirmation,
	proj_dd_settlement_account,
	proj_dd_quota_type,
	proj_dd_loan_basis,
	proj_dd_confirmation_seal,
	lend_item
} = proxy.useDict(
	"proj_dd_type",
	"proj_dd_contract_type",
...
function openDiagMulti(options) {
	...
	if (
		options == "coreEnterpriseName" &&
		tableDataMultiCoreEnterpriseName.value.length
	) {
		...
		options != "coreEnterpriseName" &&
		tableDataMultiOther.value.length
	) {
