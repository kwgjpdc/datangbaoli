        ...
        <el-row :gutter="15" style="margin-right: 30px;">
          <el-col :xl="6" :lg="8" :sm="12" :xs="24">
            <el-form-item label="机构名称" prop="institutionName">
              <el-input v-model="formData.institutionName" placeholder="请输入机构名称" clearable maxlength="64"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xl="6" :lg="8" :sm="12" :xs="24">
            <el-form-item label="工商注册号" prop="registerCode">
              <el-input v-model="formData.registerCode" placeholder="请输入工商注册号" clearable maxlength="32"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xl="6" :lg="8" :sm="12" :xs="24">
            <el-form-item label="注册资本" prop="registeredCapital">
              <ElPriceInput v-model:form="formData" prop="registeredCapital" :rules="rules" :placeholder="'请输入'">
                <template #prefix>
                  <span> ￥ </span>
                </template>
                <template #suffix>
          ...
          <el-col :xl="6" :lg="8" :sm="12" :xs="24">
            <el-form-item label="出资金额" prop="contribution">
              <ElPriceInput v-model:form="formData" prop="contribution" :rules="rules" :placeholder="'请输入'">
                <template #prefix>
                  <span> ￥ </span>
                </template>
                <template #suffix>
          ...
          <el-col :xl="6" :lg="8" :sm="12" :xs="24">
            <el-form-item label="法人代表" prop="legalRepresentative">
              <el-input v-model="formData.legalRepresentative" placeholder="请输入法人代表" clearable
...
watch(() => props.institutionInfo, value => {
