    ...
    <div class="app-container info-form-container" v-loading="loading" ref="appContainerView">
        <div class="content">
            ...
            <div class="content-item-scroll">
                <basic-info id="basicInfo" :institutionInfo="institutionInfo" ref="basicInfoRef" :institutionId="institutionId"
...
import { getInstitutionInfo, addInstitutionInfo, updateInstitutionInfo } from "@/api/institution/info.js"
...
function closePage() {
    const obj = { path: "/customer/cust/institution/info/index", query: { t: Date.now(), pageNum: routerQueryObj.value.pageNum } };
