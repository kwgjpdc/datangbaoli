  ...
  <el-form ref="elForm"
    ...
    <el-card>
      <el-table :data="formData.subList">
        ...
        <el-table-column label="同意书编号" align="center" prop="agreementNo" min-width="240"/>
        ...
        <el-table-column label="风险敞口" align="center" min-width="120">
          <template #default="scope">
        ...
        <el-table-column label="是否调整利息" align="center" min-width="120">
          <template #default="scope">
            <dict-tag :options="sys_true_or_false" :value="scope.row.isAdjustInterest" />
          </template>
        </el-table-column>
        <el-table-column label="违约金" align="center" min-width="120">
          <template #default="scope">
