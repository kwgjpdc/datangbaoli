    ...
    <div class="content">
      ...
      <div class="content-item-scroll info-form" ref="formCon">
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="金融信息" name="finance">
            <Finance v-if="infoFlag" ref="finance" :infoData="assetInfo" :routerQueryObj="routerQueryObj" @getTotalSell="setTotalSell"></Finance>
          </el-collapse-item>
        </el-collapse>
      </div>
...
import { getInfo, updateInfo } from "@/api/postLoan/repayment"
...
// 计算总值
function setTotalSell(val) {
  assetInfo.value.sellAmount = val
}
...
function closePage() {
  const obj = { path: "/postLoan/soldOut/repayment", query: { t: Date.now(), pageNum: routerQueryObj.value.pageNum } };
