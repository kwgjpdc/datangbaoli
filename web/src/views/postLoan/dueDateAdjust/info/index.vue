...
<script setup name="postLoan-dueDateAdjust">
import QueryParams from "@/components/QueryParams"
import { listInfo } from "@/api/postLoan/dueDateAdjust"
...
function handleView(row) {
  ...
  router.push({ path: '/postLoan/dueDateAdjust/detail', query: { loanId: _id, viewFlag: true, pageNum: queryParams.value.pageNum } });
}

/** 录入按钮操作 */
function handleUpdate(row) {
  const _id = row.loanId
  router.push({ path: '/postLoan/dueDateAdjust/detail', query: { loanId: _id, pageNum: queryParams.value.pageNum } });
}
