        ...
        <template #default="scope">
          <div class="button-display">
            <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
              v-hasPermi="['postLoad:risk:edit']">修改</el-button>
...
<script setup name="postLoan-risk">
import QueryParams from "@/components/QueryParams"
import { listInfo } from "@/api/postLoan/risk"
...
function handleUpdate(row) {
  const _id = row.loanId
  router.push({ path: '/postLoan/risk/detail', query: { loanId: _id, pageNum: queryParams.value.pageNum } });
}
