<template>
  <el-form class="info-form" ref="elForm" :model="formData" :rules="rules" label-width="140px"
    ...
    <el-collapse v-model="activeNames" style="border-top: 0;">
      <el-collapse-item title="融资回款信息" name="1">
        <el-row :gutter="15">
          <el-col :span="24" :xs="24">
            <el-table :data="formData.subList ? formData.subList.slice((subTablePage.currentPage - 1)*subTablePage.pageSize,subTablePage.currentPage*subTablePage.pageSize) : formData.subList" style="margin-bottom: 20px;margin-top: 15px;">
