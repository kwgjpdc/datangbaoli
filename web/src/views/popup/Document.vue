<template>
  <div class="btn-dialog">
    <el-tag class="tag-btn" @click="openDialog">单证查询</el-tag>
    <el-dialog v-model="dialogVisible" class="popup-dialog info-form-container" style="width: 95%; max-width: 1260px;" title="单证信息" :append-to-body="true">
