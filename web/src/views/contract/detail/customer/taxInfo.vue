<template>
    <el-card>
        ...
        >
            ...
            <!-- 纳税人识别号 -->
            <el-table-column label="纳税人识别号" prop="taxpayerIdentificationNumber" align="center" />
            <!-- 类型 -->
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="纳税人识别号" prop="taxpayerIdentificationNumber">
                            <el-input
                                v-model="formData.taxpayerIdentificationNumber"
